...
.. note::
    ...
    .. code-block:: console
        ...
        (venv) $ pip install albeniz

The simplest way to install albeniz is using Pip.

.. code-block:: console

    $ pip install albeniz

This will install ``albeniz`` and all of its dependencies.
...
Report bugs at the `issue tracker <https://github.com/guillego/albeniz/issues>`_.
